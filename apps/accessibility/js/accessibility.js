...
/* harmony import */ var _Accessibility_vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Accessibility.vue */ "./apps/accessibility/src/Accessibility.vue");
...
var View = vue__WEBPACK_IMPORTED_MODULE_0__["default"].extend(_Accessibility_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
__webpack_require__(/*! core-js/modules/es.array.concat */ "./node_modules/@nextcloud/initial-state/node_modules/core-js/modules/es.array.concat.js");
...
var hide = __webpack_require__(/*! ../internals/hide */ "./node_modules/@nextcloud/initial-state/node_modules/core-js/internals/hide.js");
...
/***/ "./node_modules/@nextcloud/initial-state/node_modules/core-js/internals/function-to-string.js":
/*!****************************************************************************************************!*\
  !*** ./node_modules/@nextcloud/initial-state/node_modules/core-js/internals/function-to-string.js ***!
  \****************************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/@nextcloud/initial-state/node_modules/core-js/internals/hide.js":
/*!**************************************************************************************!*\
  !*** ./node_modules/@nextcloud/initial-state/node_modules/core-js/internals/hide.js ***!
  \**************************************************************************************/
/*! no static exports found */
...
var global = __webpack_require__(/*! ../internals/global */ "./node_modules/@nextcloud/initial-state/node_modules/core-js/internals/global.js");
var nativeFunctionToString = __webpack_require__(/*! ../internals/function-to-string */ "./node_modules/@nextcloud/initial-state/node_modules/core-js/internals/function-to-string.js");
...
module.exports = __webpack_require__(/*! ../internals/global */ "./node_modules/@nextcloud/initial-state/node_modules/core-js/internals/global.js");
...
__webpack_require__(/*! core-js/modules/es.date.to-string */ "./node_modules/@nextcloud/router/node_modules/core-js/modules/es.date.to-string.js");
...
var hide = __webpack_require__(/*! ../internals/hide */ "./node_modules/@nextcloud/router/node_modules/core-js/internals/hide.js");
...
/***/ "./node_modules/@nextcloud/router/node_modules/core-js/internals/function-to-string.js":
/*!*********************************************************************************************!*\
  !*** ./node_modules/@nextcloud/router/node_modules/core-js/internals/function-to-string.js ***!
  \*********************************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/@nextcloud/router/node_modules/core-js/internals/hide.js":
/*!*******************************************************************************!*\
  !*** ./node_modules/@nextcloud/router/node_modules/core-js/internals/hide.js ***!
  \*******************************************************************************/
/*! no static exports found */
...
var global = __webpack_require__(/*! ../internals/global */ "./node_modules/@nextcloud/router/node_modules/core-js/internals/global.js");
var nativeFunctionToString = __webpack_require__(/*! ../internals/function-to-string */ "./node_modules/@nextcloud/router/node_modules/core-js/internals/function-to-string.js");
...
module.exports = __webpack_require__(/*! ../internals/global */ "./node_modules/@nextcloud/router/node_modules/core-js/internals/global.js");
...
/***/ "./node_modules/@nextcloud/router/node_modules/core-js/internals/sloppy-array-method.js":
/*!**********************************************************************************************!*\
  !*** ./node_modules/@nextcloud/router/node_modules/core-js/internals/sloppy-array-method.js ***!
  \**********************************************************************************************/
/*! no static exports found */
...
var $indexOf = __webpack_require__(/*! ../internals/array-includes */ "./node_modules/@nextcloud/router/node_modules/core-js/internals/array-includes.js").indexOf;
var sloppyArrayMethod = __webpack_require__(/*! ../internals/sloppy-array-method */ "./node_modules/@nextcloud/router/node_modules/core-js/internals/sloppy-array-method.js");
...
/***/ "./node_modules/@nextcloud/router/node_modules/core-js/modules/es.date.to-string.js":
/*!******************************************************************************************!*\
  !*** ./node_modules/@nextcloud/router/node_modules/core-js/modules/es.date.to-string.js ***!
  \******************************************************************************************/
/*! no static exports found */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_ItemPreview__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/ItemPreview */ "./apps/accessibility/src/components/ItemPreview.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'Accessibility',
  components: {
    ItemPreview: _components_ItemPreview__WEBPACK_IMPORTED_MODULE_0__["default"]
  },
  props: {
    availableConfig: {
      type: Object,
  ...
  computed: {
    ...
    description: function description() {
      ...
      return t('accessibility', "Universal access is very important to us. We follow web standards\n\t\t\t\tand check to make everything usable also without mouse,\n\t\t\t\tand assistive software such as screenreaders.\n\t\t\t\tWe aim to be compliant with the {guidelines} 2.1 on AA level,\n\t\t\t\twith the high contrast theme even on AAA level.").replace('{guidelines}', this.guidelinesLink);
    },
    guidelinesLink: function guidelinesLink() {
      return "<a target=\"_blank\" href=\"https://www.w3.org/WAI/standards-guidelines/wcag/\" rel=\"noreferrer nofollow\">".concat(t('accessibility', 'Web Content Accessibility Guidelines'), "</a>");
    },
    descriptionDetail: function descriptionDetail() {
      return t('accessibility', "If you find any issues, don\u2019t hesitate to report them on {issuetracker}.\n\t\t\t\tAnd if you want to get involved, come join {designteam}!").replace('{issuetracker}', this.issuetrackerLink).replace('{designteam}', this.designteamLink);
    },
    issuetrackerLink: function issuetrackerLink() {
      return "<a target=\"_blank\" href=\"https://github.com/nextcloud/server/issues/\" rel=\"noreferrer nofollow\">".concat(t('accessibility', 'our issue tracker'), "</a>");
    },
    designteamLink: function designteamLink() {
      return "<a target=\"_blank\" href=\"https://nextcloud.com/design\" rel=\"noreferrer nofollow\">".concat(t('accessibility', 'our design team'), "</a>");
    }
  },
  methods: {
    // SELECT handlers
     ...
     */
    selectItem: function () {
      var _selectItem = _asyncToGenerator(
      /*#__PURE__*/
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1___default()({
                  url: Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__["generateOcsUrl"])('apps/accessibility/api/v1/config', 2) + type,
              ...
              case 3:
                ...
                if (!link) {
                  ...
                  _link.href = Object(_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__["generateUrl"])('/apps/accessibility/css/user-style.css') + '?v=' + new Date().getTime();
  ...
  return _c("div", { class: { preview: true } }, [
    ...
    _c("div", { staticClass: "preview-description" }, [
      ...
      _c("label", { attrs: { for: "accessibility-" + _vm.preview.id } }, [
        _vm._v(
          _vm._s(_vm.t("accessibility", "Enable")) +
            " " +
            _vm._s(_vm.preview.title.toLowerCase())
        )
      ])
    ])
  ])
